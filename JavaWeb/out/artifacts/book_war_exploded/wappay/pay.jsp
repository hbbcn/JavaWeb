        ...
        <form name=alipayment action='' method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>商户订单号：</dt>
                    <dd>
                        <input id="WIDout_trade_no" name="WIDout_trade_no"  value="${sessionScope.orderId}"/>
                    </dd>
                    <hr class="one_line">
                    <dt>订单名称：</dt>
                    <dd>
                        <input id="WIDsubject" name="WIDsubject" value="购买的图书" />
                    </dd>
                    <hr class="one_line">
                    <dt>付款金额：</dt>
                    <dd>
                    ...
                    <dt>商品描述：</dt>
                    <dd>
                        <input id="WIDbody" name="WIDbody" value="${sessionScope.name}" />
                    </dd>
                    <hr class="one_line">
                    <dt></dt>
                    <dd id="btn-dd">
...
<%--<script language="javascript">
	function GetDateNow() {
        ...
        console.log(sNow);
		document.getElementById("WIDsubject").value = "手机网站测试商品";
